...
const SFEER_DEST = {
  ...
  stad:    ['FCO','PRG','VIE','BUD','CPH','EDI','BER','PAR','MAD','FLR','CAI','IST','ATH','ZRH','CCF','RIX','RZE','BRQ','KUN','LUZ','POZ','SVQ','MXP','PSA','VRN','SKG','SZG','BSL','KRK','PRN','LON','GLA','BIO','GRO','GRX','BLQ','MPL','CMN','OUD','TNG','FEZ','ADB','AMM','TIA','DUB','GDN','KTW','WAW','WRO','OTP','CLJ','IAS','SOF','SKP','BEG','VNO','EVN'],
  natuur:  ['KEF','BGO','INN','GVA','TRD','NOC','SCV','TZL','FNC','RVN','TOS','EVE','SPC','PDL','EGC','CMF','GNB','KTT','KAO','SCR','SFT','LJU','ORK'],
  relaxed: ['OPO','MLA','NAP','SPU','NCE','VCE','DEB'],
  ver:     ['RAK','HRG','CAI','DXB','AUH','AGA','SSH','SID','PDL','CMN','NDR','OUD','TNG','FEZ','RMF','AMM','EVN'],
